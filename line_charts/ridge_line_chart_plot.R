...
ridge_line <- ggplot(diamonds, aes(x = price, y = cut, fill = cut)) +
  geom_density_ridges(alpha = .6, colour =  "black") +
...
# Save the plot
ggsave("ridge_line_chart.png" # filename
       ,plot = ridge_line # variable for file
