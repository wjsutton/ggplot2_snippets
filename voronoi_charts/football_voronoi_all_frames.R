...
# Then in ScreenToGif knit frames together into a gif
# And to speed up animation use https://ezgif.com/speed
# Instructions available in README_FOOTBALL_VORONOI.md